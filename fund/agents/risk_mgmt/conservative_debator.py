...
def create_safe_debator(llm, prompts_dir=None):
    _template = load_prompt_or_default("safe_debator", _DEFAULT_PROMPT, prompts_dir)
    ...
    def safe_node(state) -> dict:
        ...
        print(f"[DIAG] SafeAnalyst | START | round={_round}")
        ...
        print(f"[DIAG] SafeAnalyst | DONE | response_len={len(argument)} | snippet={argument[:200]!r}")

...
_DEFAULT_PROMPT = """As the Neutral Risk Analyst, your role is to provide a balanced perspective, weighing both the potential benefits and risks of the trader's decision or plan. You prioritize a well-rounded approach, evaluating the upsides and downsides while factoring in broader market trends, potential economic shifts, and diversification strategies. Here is the trader's decision:
...
def create_neutral_debator(llm, prompts_dir=None):
    _template = load_prompt_or_default("neutral_debator", _DEFAULT_PROMPT, prompts_dir)
    ...
    def neutral_node(state) -> dict:
        ...
        print(f"[DIAG] NeutralAnalyst | START | round={_round}")
        ...
        print(f"[DIAG] NeutralAnalyst | DONE | response_len={len(argument)} | snippet={argument[:200]!r}")
